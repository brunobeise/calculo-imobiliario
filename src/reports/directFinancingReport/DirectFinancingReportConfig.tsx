...
export interface DirectFinancingReportData {
  mainPhoto: string;
  description: string;
  propertyName: string;
...
interface DirectFinancingReportConfigProps {
  data: DirectFinancingReportData;
  setData: (data: DirectFinancingReportData) => void;
}

export default function DirectFinancingReportConfig(
  props: DirectFinancingReportConfigProps
) {
  const labels = [
    "Introdução",
