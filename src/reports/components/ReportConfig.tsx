...
export default function ReportConfig(props: ReportConfigProps) {
  const labels = [
    "Introdução",
  ...
  return (
    <Sheet className="grid grid-rows shadow w-[650px] py-5 max-h-screen overflow-y-auto">
      <div className="px-5">
        <RadioGroup
          aria-label="subType"
          name="subType"
        ...
        <LinkBuildingButton
          ...
          buildingName={props.data.propertyName}
          buildingPhoto={props.data.mainPhoto}
          onUnlink={() => props.setData({ ...props.data, buildingId: null })}
          onLink={(building) => {
            props.setData({
              ...props.data,
