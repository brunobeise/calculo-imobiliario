    ...
    return (
      ...
      >
        <div className="!bg-whitefull flex flex-col items-center w-full overflow-hidden !m-0">
          {isPageViewActive(0) && (
            <div ref={page1Ref} className="w-full ">
              ...
              <div className="bg-primary  mt-10 text-white flex justify-center p-1 mx-14 text-[1.4rem]">
                <strong>
                  Melhor Cenário de Compra / Projeção em{" "}
                  {propertyData.finalYear} anos{" "}
                </strong>
              </div>
              ...
              <div className="w-full px-12 mt-10 mb-10">
                <div className=" w-full mt-5 relative">
                  ...
                  <p className="absolute text-primary w-[500px] right-0 bottom-[0rem]  text-sm xl:text-md">
                    ...
                    <strong> tabela PRICE </strong>. Como as primeiras parcelas
                    da tabela SAC são mais altas, optar pela tabela PRICE acaba
                    sendo mais vantajoso, pois a diferença entre os valores pode
                    ser usada para quitar o saldo devedor ou ser investida no
                    mercado financeiro. Esse método permite que o cliente
                    liquide a dívida antes do prazo previsto
                  </p>
            ...
            <div ref={page3Ref}>
              <div className="w-full mt-10 px-12">
                <p className="text-primary mt-5 text-lg">
                  ...
                  Observa-se um retorno significativo, tornando-se uma
                  alternativa eficaz para maximizar os ganhos financeiros em
            ...
            isPageViewActive(3) && (
              <div ref={page4Ref} className="w-full px-12 ">
                ...
                <div className="text-primary col-span-2 mb-10">
                  <p>
                    O valor presente (VP) de um pagamento mensal mostra quanto
                    um pagamento futuro vale hoje. Isso acontece porque o
                    dinheiro perde valor com o tempo. Em outras palavras, o
                    valor presente representa quanto seria necessário investir
                    hoje para alcançar um valor que será pago no futuro. Embora
                    o pagamento ou investimento mensal possa permanecer o mesmo,
                    o valor presente desse pagamento diminui quanto mais
                    distante ele estiver no tempo. Isso ajuda a entender o
                    impacto financeiro de compromissos ou investimentos futuros
                    no momento atual.
                  </p>
                </div>
                            ...
                            <tr className="text-primary">
                              ...
                              <td className="px-4 py-2 border-r border-b border-primary">
                                {toBRL(
                                  caseData.detailedTable[
                                    Math.floor(
                                      caseData.detailedTable.length / 2
                                    )
                                  ].rentalAmount * -1
                                )}
                              </td>
          ...
          {caseData.finalRow.totalCapital > 0 && isPageViewActive(4) && (
