      ...
      <div className="!bg-whitefull flex flex-col items-center w-full overflow-hidden !m-0">
                      ...
                      (caseData.detailedTable[0].rentValue -
                        ...
                        <tr className="text-primary">
                          ...
                          <td className="px-4 py-2 border-r border-b border-primary">
                            {toBRL(caseData.detailedTable[0].rentalAmount * -1)}
                          </td>
                          <td className="px-4 py-2 border-r border-b border-primary">
                            {toBRL(
                              caseData.detailedTable[0]
          ...
          <div className="w-full px-12 h-[297mm]">
            ...
            <div className="text-primary col-span-2 mb-10">
              <p>
                ...
                representa o lucro mensal gerado pelo imóvel. Quando este lucro
                é reinvestido em renda fixa, ele não apenas proporciona uma
                rentabilidade adicional, mas também contribui para o aumento do
                patrimônio ao longo do tempo. Esse estratégia de reinvestimento
                potencializa o retorno total do investimento, tornando-o mais
        ...
        {!!propertyData.cdi && propertyData.cdi !== 0 && (
          <div className="w-full px-12 h-[297mm]">
            ...
            <div className="text-primary col-span-2 mb-10">
              <p>
                No cálculo mensal do investimento imobiliário, a diferença entre
                o aluguel recebido e a parcela do financiamento pode resultar em
                um lucro positivo, que, quando reinvestido em renda fixa, gera
                rentabilidade e aumenta o patrimônio ao longo do tempo. Ao
                comparar com a taxa do CDI, o retorno do reinvestimento pode ser
                inferior ou superior ao que seria obtido aplicando o capital na
                taxa do CDI. Isso ressalta a importância de avaliar diferentes
                opções de investimento, já que o CDI oferece uma taxa média,
                enquanto o investimento imobiliário pode trazer ganhos
                adicionais por valorização e renda passiva, tornando a
                estratégia de reinvestimento mais sólida e sustentável.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 text-primary  mt-10">
              ...
              <p>
                Juros considerados:{" "}
                <span className="font-bold">{propertyData.cdi + "%/ano"}</span>
              </p>
            </div>
