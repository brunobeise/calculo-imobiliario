...
import { FinancingPlanningData } from "../calculators/FinancingPlanningCalculator";
...
export default function Conclusion({ caseData, propertyData }: ConclusionProps) {
  const data = [
    {
    ...
    <ConclusionCaseStructure
      ...
      finalNotes={
        caseData.breakEven !== 0
          ? `Break-even no mês ${caseData.breakEven}`
          : undefined
      }
    />
  );
