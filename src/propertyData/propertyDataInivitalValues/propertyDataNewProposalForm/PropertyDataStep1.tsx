...
export default function PropertyDataStep1({
  ...
  return (
    <div className="p-5 !text-blackish">
      <h4 className="font-bold text-center">Início da proposta</h4>

      <p className="my-4 text-sm">
        Para começar, defina a data de início da proposta, bem como o período
        para o qual deseja calcular os valores.
      </p>
